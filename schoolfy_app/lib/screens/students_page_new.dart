                  ...
                  SingleChildScrollView(
                    ...
                    child: Row(
                      children: [
                        ...
                        _buildModernFilterChip('Grade 1'),
                        _buildModernFilterChip('Grade 2'),
                        _buildModernFilterChip('Grade 3'),
                        _buildModernFilterChip('Grade 4'),
              ...
              builder: (context, snapshot) {
                ...
                return SliverList(
                  delegate: SliverChildBuilderDelegate(
                    (context, index) => _buildModernStudentCard(linkedStudents[index], index),
                    childCount: linkedStudents.length,
                  ),
                );
              },
            ),
